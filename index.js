...
const sessdata = config.SESSION_ID.replace("STANY-TXR-ZMD~", '');
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("STANY TXR ZMD CONNECTING TO WHATSAPP PLZ WAIT..⏳️");
...
╭─ 「 *[ •  𝕊𝕋𝔸ℝ𝕋𝔼𝔻‎ • ]* 」
┊  ╭───────────❂
┊🩶┊ *🂱 THIS PROJECT CREATED TO USE STANY TXR ZMD SCRIPT STANY TXR ZMD IS THE UPDATE VERSION OF STANY TXR ZMD ♻️*
┊  ╰──────────❂
╰─────────────❂
...
┊  ╰──────────❂
╰─────────────❂
*🂱 𝑺𝑻𝑨𝑵𝒀 𝑻𝑿𝑹 𝒁𝑴𝑫 𝑨𝑪𝑻𝑰𝑽𝑨𝑻𝑬 𝑵𝑶𝑾!♻️*\n\n*𝒀𝑶𝑼𝑹-𝑷𝑹𝑬𝑭𝑰𝑿: [${prefix}]*

*•────────────•⟢*
> *© 𝙱𝚈 𝚂𝚃𝙰𝙽𝚈 𝚃𝚉*
*•────────────•⟢*
`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ai2go2.jpg` }, caption: up })
