...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/Stanking11/STANY-TXR-ZMD/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/Stanking11/STANY-TXR-ZMD';
