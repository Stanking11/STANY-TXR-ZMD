...
cmd({
  ...
  reply("> ©𝚂𝚃𝙰𝙽𝚈 𝚃𝚇𝚁 𝚉𝙼𝙳🫅ɪs ғᴇᴛᴄʜɪɴɢ ᴀᴜᴅɪᴏ... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("𝚃𝚇𝚁 𝚉ᴍᴅ🫅: sᴘᴏᴛɪғʏ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  } else if (youtubeSent) {
    reply("𝚃𝚇𝚁 𝚉ᴍᴅ: ʏᴏᴜᴛᴜʙᴇ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  }
});
