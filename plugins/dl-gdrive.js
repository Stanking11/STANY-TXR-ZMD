...
const handler = async (m, { conn, args }) => {
  ...
  try {
    ...
    if (contentType.includes('video')) {
      ...
      await conn.sendFile(m.chat, mediaBuffer, fileName, '*Powered by STANY TXR ZMD*', m, false, { mimetype });
      m.react('✅');
    }
    // Handle image download
      ...
      await conn.sendFile(m.chat, mediaBuffer, fileName, '*Powered by Tohid-Ai*', m, false, { mimetype });
      m.react('✅');
    } else {
