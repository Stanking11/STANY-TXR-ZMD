...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/7jle25.jpg'; // Remplacez par l'URL de votre image AI
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/4r8auq.jpg'; // Replace with a valid image URL
