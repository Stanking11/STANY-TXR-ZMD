...
async (conn, mek, m, { from, prefix, quoted, q, reply, waitForReply }) => {
    try {
        ...
        let ytmsg = `╭━━━〔 *STANY-TXR-VIDEO-DOWNLOADEE* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *VIDEO DOWNLOADER*
┃▸└───────────···๏
╰────────────────┈⊷
...
let ytmsg = `╭━━━〔 *STANY-TXR-MUSIC DOWNLOADER* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *MUSIC DOWNLOADER*
┃▸└───────────···๏
╰────────────────┈⊷
...
// SEND DOC TYPE
await conn.sendMessage(from, { document: { url: ytdl.download.url }, mimetype: "audio/mpeg", fileName: ytdl.result.title + '.mp3', caption: `> *© Pᴏᴡᴇʀᴇᴅ Bʏ 𝚂𝚃𝙰𝙽𝚈-𝚃𝙴𝙲𝙷™ ♡*` }, { quoted: mek })
