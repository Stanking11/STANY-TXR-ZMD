...
async (conn, mek, m, { from, reply }) => {
    ...
    try {
        ...
        const formattedInfo = `*𝐇𝐄𝐋𝐋𝐎 𝐓𝐇𝐄𝐑𝐄😇👑* 

> *sɪᴍᴘʟᴇ, ɪᴄʏ, ᴄᴏʟᴅ  & ʀɪᴄʜ ʟᴏᴀᴅᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs,*❄️
...
\n> *> POWERED BY STANY-TECH TEAM🎐`;
        ...
        await conn.sendMessage(from, {
            image: { url: `https://files.catbox.moe/l3fp7g.jpg` },
