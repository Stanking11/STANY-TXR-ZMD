...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/4r8auq.jpg'; // Remplacez par l'URL de votre image AI
...
cmd({
    pattern: "txr3",
    desc: "Get a response from txr3 AI using the provided prompt.",
    category: "ai",
    react: "🤖",
    filename: __filename,
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/7jle25.jpg'; // Replace with a valid image URL
